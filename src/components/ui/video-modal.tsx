   ...
   <VideoModalPortal>
      ...
      >
         <div className="relative mx-auto flex size-full items-center justify-center rounded-2xl border border-gray-950/[.1] bg-gray-50/[.2] dark:border-gray-50/[.1] dark:bg-gray-950/[.5]">
            ...
            <div className="flex h-4/5 w-full max-w-7xl gap-6">
...
>(({ className, children, ...props }, ref) => {
   ...
   return (
      <div
         ref={ref}
         className={cn(
            'group relative aspect-video w-full overflow-hidden rounded-xl border border-gray-950/[.1] object-cover dark:border-gray-50/[.1]',
            isPlaying && 'playing',
            className,
         )}
...
>(({ className, children, ...props }, ref) => (
   <div
      ref={ref}
      className={cn(
         'w-full max-h-[80vh] overflow-hidden rounded-xl border border-gray-950/[.1] object-cover shadow-xl dark:border-gray-50/[.1]',
         className,
      )}
      {...props}
   >
